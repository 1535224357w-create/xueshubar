...
def init_database():
    ...
    # ===== 张宇基础30讲（高数） =====
    root_gs = KnowledgePoint(name='张宇基础30讲（高数）',
                             description='张宇基础30讲·高等数学分册')
    db.session.add(root_gs)
    db.session.flush()
    for num, name, desc in [
        (1, '函数极限与连续', '函数概念、极限计算、无穷小、连续性、间断点'),
        (2, '数列极限', '数列概念、极限定义、单调有界准则'),
        (3, '一元函数微分学的概念', '导数定义、几何意义、可导性、高阶导数'),
        (4, '一元函数微分学的应用（一）', '中值定理、泰勒公式、洛必达法则'),
        (5, '一元函数微分学的应用（二）', '单调性、极值最值、凹凸拐点、渐近线'),
        (6, '一元函数微分学的应用（三）', '中值定理综合、几何物理应用、曲率'),
        (7, '一元函数积分学概念', '原函数、不定积分、换元法、分部积分法'),
        (8, '定积分的概念与性质', '定积分定义、性质、变限积分'),
        (9, '定积分的计算', '定积分计算、换元法、分部积分法'),
        (10, '定积分的应用（一）', '面积、体积、弧长、物理应用'),
        (11, '定积分的应用（二）', '积分等式、积分不等式、证明'),
        (12, '定积分的应用（三）', '参数方程、极坐标的应用'),
        (13, '多元函数微分学', '多元函数、偏导数、全微分、复合函数求导'),
        (14, '二重积分', '二重积分概念、直角坐标与极坐标计算'),
        (15, '微分方程', '一阶微分方程、可分离变量、线性、高阶线性'),
        (16, '无穷级数', '级数收敛性、正项级数、交错级数、幂级数'),
        (17, '多元函数微分学应用', '极值、条件极值、拉格朗日乘数法'),
        (18, '隐函数与复合函数求导', '全微分条件、偏导数连续性'),
    ]:
        db.session.add(KnowledgePoint(name='第%d讲 %s' % (num, name),
                                       description=desc, parent_id=root_gs.id))

    # ===== 张宇基础30讲（线代） =====
    root_xd = KnowledgePoint(name='张宇基础30讲（线代）',
                             description='张宇基础30讲·线性代数分册')
    db.session.add(root_xd)
    db.session.flush()
    for name, desc in [
        ('零基础课——线性代数入门', '向量基本概念、向量运算、线性变换'),
        ('第1讲 行列式', '行列式的定义、性质、计算、克拉默法则'),
        ('第2讲 矩阵', '矩阵运算、逆矩阵、秩、初等变换'),
        ('第3讲 向量组', '线性相关性、秩、正交性、施密特正交化'),
        ('第4讲 线性方程组', '齐次与非齐次方程组解的结构'),
        ('第5讲 特征值与特征向量', '特征值、特征向量、相似对角化'),
        ('第6讲 二次型', '二次型标准形、正定二次型'),
    ]:
        db.session.add(KnowledgePoint(name=name, description=desc, parent_id=root_xd.id))

    # ===== 张宇基础30讲（概率） =====
    root_gl = KnowledgePoint(name='张宇基础30讲（概率）',
                             description='张宇基础30讲·概率论与数理统计分册')
    db.session.add(root_gl)
    db.session.flush()
    for name, desc in [
        ('第1讲 随机事件与概率', '事件运算、条件概率、全概率、贝叶斯公式'),
        ('第2讲 一维随机变量及其分布', '分布函数、概率密度、常见分布'),
        ('第3讲 多维随机变量及其分布', '联合分布、边际分布、条件分布'),
        ('第4讲 随机变量的数字特征', '期望、方差、协方差、相关系数'),
...
def _seed_problems_from_json():
    ...
    KP_KW = {
        ...
        '矩阵': '矩阵', '逆矩阵': '矩阵', '伴随矩阵': '矩阵',
        '向量组': '向量组', '线性相关': '向量组', '线性无关': '向量组', '施密特': '向量组',
        '线性方程组': '线性方程组', '基础解系': '线性方程组',
        '特征值': '特征值与特征向量', '特征向量': '特征值与特征向量',
        '相似': '特征值与特征向量', '对角化': '特征值与特征向量',
        '二次型': '二次型', '正定': '二次型',
        '概率': '随机事件与概率', '事件': '随机事件与概率',
        '贝叶斯': '随机事件与概率', '全概率': '随机事件与概率',
        '分布': '一维随机变量', '正态': '一维随机变量', '泊松': '一维随机变量',
        '联合分布': '多维随机变量及其分布', '边际': '多维随机变量及其分布',
        '期望': '随机变量的数字特征', '方差': '随机变量的数字特征',
    ...
    # 加载所有30讲知识节点
    lecture_ids = {}
    for root_name in ['张宇基础30讲（高数）', '张宇基础30讲（线代）', '张宇基础30讲（概率）']:
        root = KnowledgePoint.query.filter_by(name=root_name).first()
        if root:
            for l in root.children.all():
